...
export function ExecutiveSummary({ result, includeFees }: { result: CalcResult; includeFees: boolean }) {
  ...
  const cards: { label: string; value: number; tone?: "pos" | "neg"; tip: string }[] = [
    ...
    { label: "KZ 857 · Derivative net", value: f["857"], tone: f["857"] < 0 ? "neg" : "pos",
      tip: "Nicht verbriefte Derivate ohne freiwilligem Steuerabzug — net options/futures/FOP, signed. Taxed at your marginal tariff (§27a Abs. 2), NOT 27,5%. E1kv row 857." },
    ...
    { label: "KZ 863 · Dividends + bond interest", value: f["863"], tone: "pos",
      tip: "Gross foreign dividends and bond coupon interest (Zinserträge aus Wertpapieren, §27 Abs. 2) before tax. WHT tracked in KZ 998. E1kv row 863." },
  ...
  const mapping = [
    ...
    ["857", "Eink. aus nicht verbrieften Derivaten (§27a Abs. 2 — Tarif)", f["857"]],
    ["863", "Auslandsdividenden + Anleihezinsen (§27 Abs. 2, 27,5%)", f["863"]],
